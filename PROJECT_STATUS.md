...
- The live `personal-agent-bot-1` runs image `sha256:c51b1728ede1a181cb0c668a26eea32e6634ca993bfde119acd5371591334fe3`; it is healthy with zero restarts and clean startup logs, uses the existing Codex authentication volume, and has `/git-publish-secrets` and `/openai-transcription-secrets` mounted read-only.
