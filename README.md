...
Generic public file and dependency downloads are unavailable to project commands. Team crests are the narrow exception and must use the fixed API-Football `download_team_logo` tool.
