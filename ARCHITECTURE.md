...
- Receive a text task or validated image turn
...
Telegram long polling → text or validated image input → in-memory user session → cost-aware nano router → small answer or Luna/Terra/Sol Responses API → selected web/computer tools
